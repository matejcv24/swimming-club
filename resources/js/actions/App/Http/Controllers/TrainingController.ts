...
/**
 * @see \App\Http\Controllers\TrainingController::getByDate
 * @see app/Http/Controllers/TrainingController.php:74
 * @route '/trainings/by-date'
 */
 ...
 * @see app/Http/Controllers/TrainingController.php:0
